...
Learn more about Data.gov CKAN API at [data.gov/developers/apis](https://data.gov/developers/apis/).
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/datagov-ckan` | publish pending — [install from git tag](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases) |
| Python | `voxgig-sdk-datagov-ckan` | publish pending — [install from git tag](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases) |
| PHP | `voxgig-sdk/datagov-ckan` | publish pending — [install from git tag](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases) |
| Golang | `github.com/voxgig-sdk/datagov-ckan-sdk/go` | `go get github.com/voxgig-sdk/datagov-ckan-sdk/go@latest` |
| Ruby | `voxgig-sdk-datagov-ckan` | publish pending — [install from git tag](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases) |
| Lua | `voxgig-sdk-datagov-ckan` | publish pending — [install from git tag](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/datagov-ckan-sdk/go-cli` | `go install github.com/voxgig-sdk/datagov-ckan-sdk/go-cli/cmd/datagov-ckan@latest` |
| Go MCP server | `github.com/voxgig-sdk/datagov-ckan-sdk/go-mcp` | `go get github.com/voxgig-sdk/datagov-ckan-sdk/go-mcp@latest` |
