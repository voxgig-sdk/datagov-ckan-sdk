...
AQL-driven CLI and REPL for the DatagovCkan SDK. Positional arguments are
...
./datagov-ckan-cli list dataset
./datagov-ckan-cli load 1 dataset
./datagov-ckan-cli load '{id:1}' dataset
