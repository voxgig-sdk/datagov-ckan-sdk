...
func registerSDKWords(r *eng.Registry, client *sdk.DatagovCkanSDK) {
...
func runOp(client *sdk.DatagovCkanSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
