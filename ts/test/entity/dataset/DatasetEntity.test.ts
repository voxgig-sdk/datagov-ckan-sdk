...
import { DatagovCkanSDK, BaseFeature, stdutil } from '../../..'
...
describe('DatasetEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const live = 'TRUE' === process.env.DATAGOV_CKAN_TEST_LIVE
...
function basicSetup(extra?: any) {
  ...
  let client = DatagovCkanSDK.test(options, extra)
  ...
  const idmapEnvVal = process.env['DATAGOV_CKAN_TEST_DATASET_ENTID']
  ...
  const live = 'TRUE' === env.DATAGOV_CKAN_TEST_LIVE
  ...
  const setup = {
    ...
    struct,
    data: entityData,
    explain: 'TRUE' === env.DATAGOV_CKAN_TEST_EXPLAIN,
    live,
