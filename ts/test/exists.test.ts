...
describe('exists', async () => {
  ...
  //
  // DatagovCkanSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof DatagovCkanSDK, true,
      'DatagovCkanSDK.test() must return a client synchronously')
  })
