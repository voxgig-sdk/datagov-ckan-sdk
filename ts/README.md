# DatagovCkan TypeScript SDK



The TypeScript SDK for the DatagovCkan API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/datagov-ckan-sdk/releases](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases)
...
```ts
import { DatagovCkanSDK } from '@voxgig-sdk/datagov-ckan'
...
| `tester(testopts?, sdkopts?)` | `DatagovCkanSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DatagovCkanSDK.test(testopts?, sdkopts?)` | `DatagovCkanSDK` | Create a test-mode client. |
...
| `client` | `client(): DatagovCkanSDK` | Return the parent SDK client. |
...
datagov-ckan/
├── src/
│   ├── DatagovCkanSDK.ts        # Main SDK class
