...
// DatagovCkan SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DatagovCkanSDK::test)
...
{
    private const SDK_CLASS = 'DatagovCkanSDK';
    ...
    private const SDK_BASE = 'datagovckan_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../datagovckan_sdk.php';
