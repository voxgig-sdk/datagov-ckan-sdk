...
The PHP SDK for the DatagovCkan API — an entity-oriented client using PHP conventions.
...
```php
$client = DatagovCkanSDK::test($testopts, $sdkopts);
```
...
| `organization` | `array` | Organization information |
...
```
php/
├── datagovckan_sdk.php          -- Main SDK class
...
The main class (`datagovckan_sdk.php`) exports the SDK class
