...
// DatagovCkan SDK telemetry feature
...
class DatagovCkanTelemetryFeature extends DatagovCkanBaseFeature
{
    ...
    private function _close(DatagovCkanContext $ctx, bool $ok): void
    {
