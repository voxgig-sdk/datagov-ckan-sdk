...
// DatagovCkan SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DatagovCkanTestFeature extends DatagovCkanBaseFeature
{
    ...
    public function init(DatagovCkanContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DatagovCkanContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DatagovCkanParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DatagovCkanContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DatagovCkanContext $ctx, $op, $args): array
    {
