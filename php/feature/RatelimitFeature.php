...
// DatagovCkan SDK ratelimit feature
...
class DatagovCkanRatelimitFeature extends DatagovCkanBaseFeature
{
    ...
    private function _acquire(DatagovCkanContext $ctx): void
    {
    ...
    private function _track(DatagovCkanContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
