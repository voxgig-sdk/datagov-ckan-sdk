...
class DatagovCkanRbacFeature extends DatagovCkanBaseFeature
{
    ...
    private function _required(DatagovCkanContext $ctx): ?string
    {
    ...
    private function _reject(DatagovCkanContext $ctx, string $required): void
    {
    ...
    private function _track(DatagovCkanContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
