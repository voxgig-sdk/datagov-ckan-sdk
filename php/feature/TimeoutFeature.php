...
// DatagovCkan SDK timeout feature
...
class DatagovCkanTimeoutFeature extends DatagovCkanBaseFeature
{
    ...
    private function _with_timeout(DatagovCkanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DatagovCkanContext $_ctx, float $ms): void
    {
        $client = $this->client;
