...
// DatagovCkan SDK streaming feature
...
class DatagovCkanStreamingFeature extends DatagovCkanBaseFeature
{
    ...
    private function _iterate(DatagovCkanResult $result): \Generator
    {
    ...
    private function _streamable(DatagovCkanContext $ctx): bool
    {
