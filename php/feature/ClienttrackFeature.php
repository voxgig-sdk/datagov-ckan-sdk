...
// DatagovCkan SDK clienttrack feature
...
class DatagovCkanClienttrackFeature extends DatagovCkanBaseFeature
{
    ...
    public function PostConstruct(DatagovCkanContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DatagovCkan-SDK';
