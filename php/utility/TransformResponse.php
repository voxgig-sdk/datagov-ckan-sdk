...
// DatagovCkan SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DatagovCkanTransformResponse
{
    public static function call(DatagovCkanContext $ctx): mixed
    {
        ...
        $transform = DatagovCkanHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
