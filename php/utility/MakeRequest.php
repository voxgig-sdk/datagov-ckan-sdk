...
// DatagovCkan SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DatagovCkanMakeRequest
{
    public static function call(DatagovCkanContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DatagovCkanResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DatagovCkanResponse($fetched);
        } else {
