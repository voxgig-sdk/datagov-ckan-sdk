...
// DatagovCkan SDK utility: fetcher

class DatagovCkanFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DatagovCkanSDK/1.0)';
    ...
    public static function call(DatagovCkanContext $ctx, string $fullurl, array $fetchdef): array
    {
