...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dataset"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DatagovCkanSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "datagov-ckan_list",
		Description: "List records from DatagovCkan. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "datagov-ckan_load",
		Description: "Load a single record from DatagovCkan. " +
...
func runOp(client *sdk.DatagovCkanSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DatagovCkanSDK, name string) (sdk.DatagovCkanEntity, error) {
