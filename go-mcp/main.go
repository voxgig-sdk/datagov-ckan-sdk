// Command DatagovCkan-mcp is an MCP server exposing the DatagovCkan
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DatagovCkan_list  — list records of an entity
//	DatagovCkan_load  — load a single record of an entity
//
