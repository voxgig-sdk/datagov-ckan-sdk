...
from datagovckan_sdk.utility import register

# Load features
from datagovckan_sdk.feature.base_feature import DatagovCkanBaseFeature
from datagovckan_sdk.features import _has_feature, _make_feature
...
class DatagovCkanSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DatagovCkanUtility()
        self._utility = utility

        from datagovckan_sdk.config import shared_config
    ...
    def get_utility(self):
        return DatagovCkanUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DatagovCkanSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Dataset(self, data=None) -> "DatasetEntity":
        ...
        from datagovckan_sdk.entity.dataset_entity import DatasetEntity
        return DatasetEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "DatagovCkanSDK":
        if sdkopts is None:
            sdkopts = {}
