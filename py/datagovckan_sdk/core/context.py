...
from datagovckan_sdk.core.helpers import get_ctx_prop, to_map
...
class DatagovCkanContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DatagovCkanSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DatagovCkanResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DatagovCkanResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DatagovCkanError(code, msg, self)
