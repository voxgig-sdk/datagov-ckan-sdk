# DatagovCkan SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DatagovCkanSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DatagovCkanSDK(...) and DatagovCkanSDK.test(...) become
#      DatagovCkanSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "datagovckan_sdk"
_SDK_CLASS = "DatagovCkanSDK"
