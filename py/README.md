# DatagovCkan Python SDK



The Python SDK for the DatagovCkan API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases)) or
...
```
py/
├── datagovckan_sdk.py         -- Main SDK module
...
The main module (`datagovckan_sdk`) exports the SDK class.
