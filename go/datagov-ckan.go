...
// instead of `sdk.NewDatagovCkanSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DatagovCkanSDK  { return NewDatagovCkanSDK(nil) }
func Test() *DatagovCkanSDK { return TestSDK(nil, nil) }
