# DatagovCkan Golang SDK Reference

Complete API reference for the DatagovCkan Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *DatagovCkanSDK`
...
#### `Dataset(data map[string]any) DatagovCkanEntity`
