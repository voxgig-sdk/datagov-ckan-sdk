# DatagovCkan Golang SDK



The Golang SDK for the DatagovCkan API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/datagov-ckan-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/datagov-ckan-sdk/go=../datagov-ckan-sdk/go
```
...
import (
    "fmt"
    sdk "github.com/voxgig-sdk/datagov-ckan-sdk/go"
)
...
```go
func NewDatagovCkanSDK(options map[string]any) *DatagovCkanSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DatagovCkanSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### DatagovCkanSDK methods
...
| `Dataset` | `(data map[string]any) DatagovCkanEntity` | Create a Dataset entity instance. |

### Entity interface (DatagovCkanEntity)

All entities implement the `DatagovCkanEntity` interface.
...
| `facets` | `map[string]any` | Facet results |
...
| `organization` | `map[string]any` | Organization information |
...
```
github.com/voxgig-sdk/datagov-ckan-sdk/go/
├── datagov-ckan.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/datagov-ckan-sdk/go`) re-exports everything needed
