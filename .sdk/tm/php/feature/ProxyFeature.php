...
class DatagovCkanProxyFeature extends DatagovCkanBaseFeature
{
    ...
    public function init(DatagovCkanContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DatagovCkanContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
