...
// DatagovCkan SDK metrics feature
...
class DatagovCkanMetricsFeature extends DatagovCkanBaseFeature
{
    ...
    private function _record(DatagovCkanContext $ctx, bool $ok): void
    {
