...
class DatagovCkanCacheFeature extends DatagovCkanBaseFeature
{
    ...
    private function _through(DatagovCkanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
