...
// DatagovCkan SDK netsim feature
...
class DatagovCkanNetsimFeature extends DatagovCkanBaseFeature
{
    ...
    private function _simulate(DatagovCkanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DatagovCkanContext $ctx, array $applied): void
    {
        $client = $this->client;
