...
// DatagovCkan SDK utility: graphql
//
...
class DatagovCkanGraphql
{
    ...
    // equivalent.
    public static function body(DatagovCkanContext $ctx): mixed
    {
    ...
    public static function errors(DatagovCkanContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
