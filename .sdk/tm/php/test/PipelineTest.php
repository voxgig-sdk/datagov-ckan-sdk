...
{
    private static function utility(): DatagovCkanUtility
    {
        return new DatagovCkanUtility();
    }
    ...
    private static function ctx(array $over = []): DatagovCkanContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DatagovCkanContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DatagovCkanOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DatagovCkanError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DatagovCkanOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DatagovCkanMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DatagovCkanOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DatagovCkanMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DatagovCkanOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DatagovCkanMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DatagovCkanSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DatagovCkanMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DatagovCkanResponse([]),
            'result' => new DatagovCkanResult([]),
        ]);
        [, $err] = DatagovCkanMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DatagovCkanSpec([]),
            'response' => null,
            'result' => new DatagovCkanResult([]),
        ]);
        [, $err] = DatagovCkanMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DatagovCkanSpec(['step' => 's']),
            'response' => new DatagovCkanResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DatagovCkanResult([]),
        ]);
        [, $err] = DatagovCkanMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DatagovCkanSpec(['step' => 's']),
            'response' => new DatagovCkanResponse(self::resp(200, ['v' => 1])),
            'result' => new DatagovCkanResult([]),
        ]);
        [, $err] = DatagovCkanMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DatagovCkanSpec(['step' => 's']),
            'response' => new DatagovCkanResponse(self::resp(200, ['v' => 2])),
            'result' => new DatagovCkanResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DatagovCkanMakeResponse::call($ctx);
    ...
    {
        $preset = new DatagovCkanResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DatagovCkanSpec([]),
            'response' => new DatagovCkanResponse([]),
            'result' => new DatagovCkanResult([]),
        ...
        [$got, $err] = DatagovCkanMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DatagovCkanResult([])]);
        [, $err] = DatagovCkanMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DatagovCkanSpec([]), 'result' => null]);
        [, $err] = DatagovCkanMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DatagovCkanSpec(['step' => 's']),
            'result' => new DatagovCkanResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DatagovCkanOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DatagovCkanMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DatagovCkanSpec(['step' => 's']),
            'result' => new DatagovCkanResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DatagovCkanOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DatagovCkanMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DatagovCkanResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DatagovCkanSpec([]),
            'result' => new DatagovCkanResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DatagovCkanMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DatagovCkanMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DatagovCkanError('boom', 'boom');
        $utility->fetcher = function (DatagovCkanContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DatagovCkanSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DatagovCkanMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DatagovCkanContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DatagovCkanMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DatagovCkanResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DatagovCkanMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DatagovCkanContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DatagovCkanSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DatagovCkanMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DatagovCkanResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DatagovCkanSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DatagovCkanMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DatagovCkanMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DatagovCkanMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DatagovCkanResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DatagovCkanDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DatagovCkanResult(['ok' => false])]);
        $this->expectException(DatagovCkanError::class);
        DatagovCkanDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DatagovCkanResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DatagovCkanMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DatagovCkanMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DatagovCkanBaseFeature();
        $b = new DatagovCkanBaseFeature();
        DatagovCkanFeatureAdd::call($ctx, $a);
        DatagovCkanFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DatagovCkanBaseFeature
    {
        $f = new DatagovCkanBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DatagovCkanFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DatagovCkanContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DatagovCkanSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DatagovCkanPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DatagovCkanPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DatagovCkanResponse(['headers' => null]),
            'result' => new DatagovCkanResult([]),
        ]);
        DatagovCkanResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        DatagovCkanResultBody::call($ctx);
