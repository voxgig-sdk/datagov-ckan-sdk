...
The Lua SDK for the DatagovCkan API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/datagov-ckan-sdk/releases)),
...
| `facets` | `table` | Facet results |
| `groups` | `table` | Groups this dataset belongs to |
...
| `organization` | `table` | Organization information |
| `resources` | `table` | Dataset resources with URLs |
| `results` | `table` | Array of dataset metadata |
| `sort` | `string` | Sort order used |
| `tags` | `table` | Dataset tags |
...
```
lua/
├── datagov-ckan_sdk.lua    -- Main SDK module
...
The main module (`datagov-ckan_sdk`) exports the SDK constructor
