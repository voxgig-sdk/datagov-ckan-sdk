...
#      offline in seeded test mode (DatagovCkanSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DatagovCkan_sdk.rb")
  SDK_CLASS = "DatagovCkanSDK"
